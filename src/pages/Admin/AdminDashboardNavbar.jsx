        ...
        <React.Fragment>
            <div className='h-screen z-[1]'>
                ...
                <div className='h-screen'>
                    <div className={`fixed top-0 left-0  h-screen bg-rose-700 text-white w-[40vw] sm:w-[30vw] md:w-[20vw] lg:w-[15vw] shadow-2xl py-8 transition-transform duration-300 ease-in-out ${showNavbar ? "translate-x-0" : "-translate-x-full"} sm:translate-x-0`}>
